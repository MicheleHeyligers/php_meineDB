...
<html lang="de">
	...
	<body>
        <h2>Datensatz wählen zur Veränderung</h2>
        <!-- <section id='delete'> -->
        <?php
            ...
            echo "<form method='POST' action='db_tbl_aendern_meinedb2.php'>";
            for($i = 0; $i < $dsAnzahl; $i++){
                $ds = mysqli_fetch_row($resultat); // extrahiert jeden Datensatz, ansprechen mit Index '$ds[4]'
            ...
            echo"<p><input id='aenderung' type='submit' name='aendern' value='Datensatz auswählen'></p>";
            echo"</form>";    
        ?>
        <!-- </section> -->
        <div id="buttons_div">
